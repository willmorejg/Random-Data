...
/**
 * Address state data generator.
 * 
 * @author James G. Willmore
 * 
 */
@Component
public class AddressStateGeneratorImpl extends
        AbstractGenerator<AddressStateDataDefinitionImpl> implements
        AddressStateGenerator {
